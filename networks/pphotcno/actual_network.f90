...
contains
  ...
  subroutine actual_network_init
    ...
    ! set the names of the reaction rates
  	ratenames(irc12pg  ) = 'rc12pg' 
  	ratenames(irn13gp  ) = 'rn13gp' 
  	ratenames(irn13enu ) = 'rn13enu'
  	ratenames(irc13pg  ) = 'rc13pg' 
  	ratenames(irn14gp  ) = 'rn14gp' 
  	ratenames(irn14pg  ) = 'rn14pg' 
  	ratenames(iro15gp  ) = 'ro15gp' 
  	ratenames(iro15enu ) = 'ro15enu'
  	ratenames(irn15pa  ) = 'rn15pa'  
  	ratenames(irc12ap  ) = 'rc12ap' 
  	ratenames(irn15pg  ) = 'rn15pg' 
  	ratenames(iro16gp  ) = 'ro16gp' 
  	ratenames(iro16pg  ) = 'ro16pg' 
  	ratenames(irf17gp  ) = 'rf17gp' 
  	ratenames(irf17enu ) = 'rf17enu'
  	ratenames(iro17pa  ) = 'ro17pa' 
  	ratenames(irn14ap  ) = 'rn14ap' 
  	ratenames(iro17pg  ) = 'ro17pg' 
  	ratenames(irf18gp  ) = 'rf18gp' 
  	ratenames(irf18enu ) = 'rf18enu'
  	ratenames(iro18pa  ) = 'ro18pa' 
  	ratenames(irn15ap  ) = 'rn15ap' 
  	ratenames(iro18pg  ) = 'ro18pg' 
  	ratenames(irf19gp  ) = 'rf19gp' 
  	ratenames(irf19pa  ) = 'rf19pa' 
  	ratenames(iro16ap  ) = 'ro16ap' 
  	ratenames(irn13pg  ) = 'rn13pg' 
  	ratenames(iro14gp  ) = 'ro14gp' 
  	ratenames(iro14enu ) = 'ro14enu'
  	ratenames(iro14ap  ) = 'ro14ap' 
  	ratenames(irf17pa  ) = 'rf17pa' 
  	ratenames(irf17pg  ) = 'rf17pg' 
  	ratenames(irne18gp ) = 'rne18gp'
  	ratenames(irne18enu) = 'rne18en'
  	ratenames(irf18pa  ) = 'rf18pa' 
 	ratenames(iro15ap  ) = 'ro15ap' 
  	ratenames(ir3a     ) = 'r3a'    
  	ratenames(irg3a    ) = 'rg3a'   
 	ratenames(iroag    ) = 'roag'   
  	ratenames(irne18ap ) = 'rne18ap'
  	ratenames(iro15ag  ) = 'ro15ag' 
  	ratenames(irne19pg ) = 'rne19pg'
  	ratenames(irsi26ap ) = 'rsi26ap'
  	ratenames(irtiap   ) = 'rtiap'  
  	ratenames(irpp     ) = 'rpp'    
  	ratenames(irdpg    ) = 'rdpg'   
  	ratenames(ir33     ) = 'r33'    
  	ratenames(irhe3ag  ) = 'rhe3ag' 
  	ratenames(irbeec   ) = 'rbeec'  
  	ratenames(irbepg   ) = 'rbepg'  
  	ratenames(irb8gp   ) = 'rb8gp'  
  	ratenames(irb8ep   ) = 'rb8ep'  
  	ratenames(irli7pa  ) = 'rli7pa' 
  	ratenames(irpep    ) = 'rpep'   
  	ratenames(irhep    ) = 'rhep'   
  	ratenames(ircag    ) = 'rcag'   
  	ratenames(iroga    ) = 'roga'   
 	ratenames(irne19enu) = 'rne19en'
  	ratenames(irne20pg ) = 'rne20pg'
  	ratenames(iralam1  ) = 'ralam1' 
  	ratenames(irdelta1 ) = 'rdelta1'
  	ratenames(iralam2  ) = 'ralam2' 
  	ratenames(irdelta2 ) = 'rdelta2'
